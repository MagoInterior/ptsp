...
Aqua.addCommand({pattern: 'degis ?(.*)', fromMe: true, desc: Lang.DEGİS_DESC, deleteCommand: false }, (async (message, match) => {
...
Aqua.addCommand({pattern: 'restart$', fromMe: true, desc: Lang.RESTART_DESC , deleteCommand: false}, (async (message, match) => {
...
Aqua.addCommand({pattern: 'shutdown$', fromMe: true, desc: Lang.SHUTDOWN_DESC, deleteCommand: false }, (async(message, match) => {
...
if (Config.WORKTYPE == 'private') {
    ...
    Aqua.addCommand({pattern: 'dyno$', fromMe: true, desc: Lang.DYNO_DESC, deleteCommand: false}, (async (message, match) => {
    ...
    Aqua.addCommand({pattern: 'dyno$', fromMe: false, desc: Lang.DYNO_DESC, deleteCommand: false }, (async (message, match) => {
...
Aqua.addCommand({pattern: 'setvar ?(.*)', fromMe: true, desc: Lang.SETVAR_DESC , deleteCommand: false }, (async(message, match) => {
...
Aqua.addCommand({pattern: 'delvar ?(.*)', fromMe: true, desc: Lang.DELVAR_DESC, deleteCommand: false }, (async (message, match) => {
...
Aqua.addCommand({pattern: 'getvar ?(.*)', fromMe: true, desc: Lang.GETVAR_DESC, deleteCommand: false}, (async (message, match) => {
